function [factorResults] = reconstructTemporalSpatialPCAData(data,factorResults)

    % takes the output of a spatial PCA after a temporal PCA and reconstructs the Factor Scores
    % into scores.
    ...
    factorResults.TSPCAScores = scoreData;
