function ep_expandEyePlot(src,eventdata)
% ep_expandEyePlot - ep_expandEyePlot -
...
%        if any(colorData(iPoint,:)>.5)
            ...
            if strcmp(EPscanCont.dataType,'VLT')
                ...
                scatter(Xdata(iPoint),Ydata(iPoint),240,'filled','MarkerFaceAlpha',2/8,'MarkerFaceColor',colorData(iPoint,:));
            end;
%        end;
    end;
else
